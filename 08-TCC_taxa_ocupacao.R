...
investiga_taxa_maior_que_100 <- FALSE

if (investiga_taxa_maior_que_100) {
...
# joined_vacinas tem a taxa de vacinação em uma data em uma região intermediária, com sua geometria
